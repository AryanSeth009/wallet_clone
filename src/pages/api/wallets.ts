    ...
    switch (method) {
      ...
      case 'POST':
        ...
        try {
          ...
          if (saveError instanceof Error && 'errors' in saveError) {
            errorResponse.message = 'Validation error';
            errorResponse.error = 'VALIDATION_ERROR';
            // Type assertion for errors property
            const errorsObj = (saveError as any).errors;
            errorResponse.details = Object.values(errorsObj)
