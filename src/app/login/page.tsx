      ...
      <div className="w-full max-w-md bg-gray-900/50 backdrop-blur-xl border border-gray-800 p-8 rounded-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <label htmlFor="email" className="block !rounded-full text-sm text-gray-400">
              Email
            </label>
            <input
              id="email"
          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/account-verify" className="text-sm text-purple-400 hover:text-purple-300">
              Account issues?
            </Link>
          </div>
