    ...
    <div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-center">
          <button className="p-2 rounded-xl bg-[#1A1B23] text-[#A0AEC0] hover:bg-[#1A1B23]/80 transition-colors">
        ...
        <button className="w-full py-3 bg-gradient-to-r from-[#8A2BE2] to-[#00BFFF] text-white !rounded-2xl font-medium hover:opacity-90 transition-opacity">
          Swap Now
        </button>
      </div>
    </div>
