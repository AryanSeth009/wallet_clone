...
const filterDataByPeriod = (data: StockData[], period: TimePeriod) => {
...
export default function StockMarket() {
  ...
  const formatChartData = () => {
    ...
    const filteredData = filterDataByPeriod(stocks[selectedStock], selectedPeriod as TimePeriod)
  ...
  const latestStockData = selectedStock && stocks[selectedStock] ? stocks[selectedStock][0] : undefined
